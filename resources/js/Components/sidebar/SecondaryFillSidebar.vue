<template>
    <div>
        ...
        <div
            class="hidden overflow-hidden flex-shrink-0 md:flex md:flex-col md:w-64 md:border-r-2 md:border-gray-100 md:pt-5 md:pb-4 md:px-8 min-h-screen">
